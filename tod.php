...
<section class="section">
    <div class="container">
      <h1 class="title">
        Hier COVID Todesfälle für gestern und heute.
      </h1>
      <h6 class="subtitle is-6">Todesfälle werden jeden Tag zwischen 9:30 und 12 aktualisiert</h6>
      <p class="subtitle">
...
//  echo '<br>';
 ...
 if ($date === $today){
     ...
     echo 'Heute <strong>' . $yesterday . '</strong> mehr todfälle in Östereich.';
     echo '<br>';
     echo 'Insgesamt <strong>' . $tod . '</strong> todfälle.';
     echo '<br>';

 } 

 if ($date === $yesterday_date){
    echo 'Gestern <strong>' . $yesterday . '</strong> todfälle in Östereich.';
    echo '<br>';
    echo 'Gestern Insgesamt <strong>' . $tod . '</strong> todfälle.';
    echo '<br>';
}

if ($date === $twoday){
    echo 'Vorgestern <strong>' . $yesterday . '</strong> todfälle in Östereich.';
    echo '<br>';
    echo 'Vorgestern Insgesamt <strong>' . $tod . '</strong> todfälle.';
    echo '<br>';
    echo '<br>';
}
